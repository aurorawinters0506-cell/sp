...
import logoAsset from "@/assets/smart-point-logo.jpeg.asset.json";
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-30 flex h-[68px] items-center gap-4 border-b border-border bg-sidebar/95 px-4 backdrop-blur-xl lg:px-6">
        <Link to="/" className="flex shrink-0 items-center gap-3">
          <img src={logoAsset.url} alt="Smart Point" className="h-11 w-11 rounded-full object-cover shadow-glow" />
